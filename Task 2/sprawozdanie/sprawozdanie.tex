...
\section{Opis architektury sieci neuronowej}
{
	...
	2. Liczebność neuronów w poszczególnych warstwach ukrytych -  30, 30, 30 \\
	...
	4. Liczba próbek z poprzednich chwil czasowych wykorzystywanych przez sieć neuronową - 100 \\
	5. Wagach poszczególnych neuronów w warstwach \\
 }
...
\bibitem{pluralsight} Pluralsight - tutorial
	\textsl{Algorytm A* \url{https://www.pluralsight.com/guides/machine-learning-neural-networks-scikit-learn}}
\end{thebibliography}
